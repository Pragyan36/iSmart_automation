...
// class ReceiveBanksListWidget extends StatefulWidget {
//   const ReceiveBanksListWidget({Key? key, required this.onBankSelected})
//       : super(key: key);
//   final Function(Bank) onBankSelected;
//   @override
//   State<ReceiveBanksListWidget> createState() => _BanksListWidgetState();
// }

// class _BanksListWidgetState extends State<ReceiveBanksListWidget> {
//   bool _showTitleAndDesc = true;

//   @override
//   void initState() {
//     super.initState();
//     context.read<ReceiveFromBankCubit>().fetchBanksList();
//   }
...
//           BlocConsumer<ReceiveFromBankCubit, CommonState>(
